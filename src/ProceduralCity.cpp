...
void draw(bool t = false) {
    ...
    for (GLint i = 0; i < 6; ++i) {
        ...
        for (GLint j = 0; j < 4; ++j) {
            float texCoords[2];
            switch (j) {
            case 0: texCoords[0] = 0.0f; texCoords[1] = 0.0f; wall.pos1 = glm::vec3(vBuilding[quad[i][j]][0], vBuilding[quad[i][j]][1], vBuilding[quad[i][j]][2]); break;
            case 1: texCoords[0] = 1.0f; texCoords[1] = 0.0f; wall.pos2 = glm::vec3(vBuilding[quad[i][j]][0], vBuilding[quad[i][j]][1], vBuilding[quad[i][j]][2]); break;
            case 2: texCoords[0] = 1.0f; texCoords[1] = repeat; wall.pos3 = glm::vec3(vBuilding[quad[i][j]][0], vBuilding[quad[i][j]][1], vBuilding[quad[i][j]][2]); break;
            case 3: texCoords[0] = 0.0f; texCoords[1] = repeat; wall.pos4 = glm::vec3(vBuilding[quad[i][j]][0], vBuilding[quad[i][j]][1], vBuilding[quad[i][j]][2]); break;
            }
